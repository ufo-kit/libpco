...
uint32_t GetError(uint32_t dwerr)
{
  return dwerr & 0xC000FFFF;
}

uint32_t GetErrorSource(uint32_t dwerr)
{
...
// REG_uint32_t EthernetHeartbeatTimoutMs and set it to e.g. 0xFD00 under the following key:
